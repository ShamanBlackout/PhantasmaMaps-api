...
exports.continuationByteMask = exports.continuationBytePrefix = exports.leadingByteLength4Prefix = exports.leadingByteLength3Prefix = exports.leadingByteLength2Prefix = exports.leadingByteLength1Prefix = void 0;
...
function writeUtf8StringFromCodePoints(buffer, position, dataToWrite) {
    if (typeof dataToWrite === "string") {
        dataToWrite = Array
            .from(dataToWrite)
            .map(char => { var _a; return (_a = char.codePointAt(0)) !== null && _a !== void 0 ? _a : Number.NaN; });
    }
