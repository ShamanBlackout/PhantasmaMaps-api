...
class BinaryWriter {
    ...
    constructor(arg1, arg2) {
        this._position = 0;
        const endiannessArg = arg2 !== null && arg2 !== void 0 ? arg2 : arg1;
        if (endiannessArg !== undefined && typeof endiannessArg === 'number' && (0, Endianness_1.isValidEndianness)(endiannessArg)) {
            this.endianness = endiannessArg;
        }
        else {
            this.endianness = Endianness_1.Endianness.Little;
        }
    ...
    writeChar(character, encoding = Encoding_1.Encoding.Utf8) {
        ...
        this._position = (0, Utf8_1.writeUtf8StringFromCodePoints)(this._buffer, this._position, typeof character === "number" ? [character] : [character.codePointAt(0)]);
        this._length = Math.max(this._length, this._position);
    }
    /**
