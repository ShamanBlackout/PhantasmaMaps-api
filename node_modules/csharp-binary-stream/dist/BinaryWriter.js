...
class BinaryWriter {
    ...
    set endianness(value) {
        if (!(0, Endianness_1.isValidEndianness)(value)) {
            throw new InvalidArgumentError_1.InvalidArgumentError('`endianness` must be a value from the Endianness enum', 'endianness', value);
        }
        this._endianness = value;
    }
    constructor(arg1, arg2) {
        this._position = 0;
        this._endianness = Endianness_1.Endianness.Little;
    ...
    writeLong(value) {
        ...
        assertBigIntSize('long', Numbers_1.Numbers.LONG.MIN, Numbers_1.Numbers.LONG.MAX, value);
    ...
    writeUnsignedLong(value) {
        ...
        assertBigIntSize('unsigned long', Numbers_1.Numbers.ULONG.MIN, Numbers_1.Numbers.ULONG.MAX, value);
        const bigint = BigInt(value);
        const smallHalf = Number(bigint & BigInt(0xFFFFFFFF));
        const bigHalf = Number((bigint >> BigInt(32)) & BigInt(0xFFFFFFFF));
        if (this.endianness === Endianness_1.Endianness.Little) {
     ...
     */
    writeChar(character, encoding = Encoding_1.Encoding.Utf8) {
        var _a;
        if (character === null) {
        ...
        this._position = (0, Utf8_1.writeUtf8StringFromCodePoints)(this._buffer, this._position, typeof character === "number"
            ? [character]
            : [(_a = character.codePointAt(0)) !== null && _a !== void 0 ? _a : Number.NaN]);
        this._length = Math.max(this._length, this._position);
    }
    /**
     ...
     */
    writeChars(characters, encoding = Encoding_1.Encoding.Utf8) {
        if (characters === null) {
        ...
        this._position = (0, Utf8_1.writeUtf8StringFromCodePoints)(this._buffer, this._position, characters);
        this._length = Math.max(this._length, this._position);
    }
    /**
     ...
     */
    writeString(value, encoding = Encoding_1.Encoding.Utf8) {
        if (value === null) {
        ...
        const tempBuffer = [];
        (0, Utf8_1.writeUtf8StringFromCodePoints)(tempBuffer, 0, value);
