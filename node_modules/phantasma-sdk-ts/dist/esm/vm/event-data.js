...
(function (EventKind) {
    ...
    EventKind[EventKind["OwnerAdded"] = 50] = "OwnerAdded";
    EventKind[EventKind["OwnerRemoved"] = 51] = "OwnerRemoved";
    EventKind[EventKind["DomainCreate"] = 52] = "DomainCreate";
    EventKind[EventKind["DomainDelete"] = 53] = "DomainDelete";
    EventKind[EventKind["TaskStart"] = 54] = "TaskStart";
    EventKind[EventKind["TaskStop"] = 55] = "TaskStop";
    EventKind[EventKind["CrownRewards"] = 56] = "CrownRewards";
    EventKind[EventKind["Infusion"] = 57] = "Infusion";
    EventKind[EventKind["Crowdsale"] = 58] = "Crowdsale";
    EventKind[EventKind["OrderBid"] = 59] = "OrderBid";
    EventKind[EventKind["ContractKill"] = 60] = "ContractKill";
    EventKind[EventKind["OrganizationKill"] = 61] = "OrganizationKill";
    EventKind[EventKind["MasterClaim"] = 62] = "MasterClaim";
    EventKind[EventKind["ExecutionFailure"] = 63] = "ExecutionFailure";
    EventKind[EventKind["Custom"] = 64] = "Custom";
    EventKind[EventKind["Custom_V2"] = 65] = "Custom_V2";
    EventKind[EventKind["GovernanceSetGasConfig"] = 66] = "GovernanceSetGasConfig";
    EventKind[EventKind["GovernanceSetChainConfig"] = 67] = "GovernanceSetChainConfig";
    EventKind[EventKind["TokenSeriesCreate"] = 68] = "TokenSeriesCreate";
    EventKind[EventKind["SpecialResolution"] = 69] = "SpecialResolution";
})(EventKind || (EventKind = {}));
export var TypeAuction;
...
export function getTokenEventData(str) {
    const dec = new Decoder(str);
    return {
...
export function getChainValueEventData(str) {
    const dec = new Decoder(str);
    return {
        name: dec.readString(),
...
export function getTransactionSettleEventData(str) {
    const dec = new Decoder(str);
    return {
...
export function getGasEventData(str) {
    const dec = new Decoder(str);
    return {
...
export function getInfusionEventData(str) {
    const dec = new Decoder(str);
...
export function getMarketEventData(str) {
    const dec = new Decoder(str);
    return {
