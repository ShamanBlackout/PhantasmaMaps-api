...
import { Address, Describer, PBinaryReader, PBinaryWriter, Serialization } from '../types/index.js';
...
export class VMObject {
    ...
    GetChildren() {
        return this.Type == VMType.Struct ? this.Data : null;
    }
    get Size() {
        let total = 0;
    ...
    AsString() {
        switch (this.Type) {
            ...
            case VMType.Number:
                return this.Data.toString();
            case VMType.Bytes:
                return uint8ArrayToStringDefault(this.Data);
            case VMType.Enum:
                return this.Data.toString();
            case VMType.Object:
            ...
            case VMType.Struct:
                ...
                if (arrayType === VMType.Number) {
                    ...
                    for (let i = 0; i < children.size; i++) {
                        ...
                        const ch = String.fromCharCode(val.AsNumber());
                        sb += ch;
                    }
                    return sb;
                }
    ...
    AsNumber() {
        if ((this.Type === VMType.Object || this.Type === VMType.Timestamp) &&
    ...
    static isSerializable(type) {
        return (type instanceof ISerializable ||
    ...
    static ConvertObjectInternal(fieldValue, fieldType) {
        if ((VMObject.isStructOrClass(fieldType) && fieldValue instanceof Uint8Array) ||
            ...
            const bytes = fieldValue;
            fieldValue = Serialization.Unserialize(bytes, typeof fieldType);
        }
    ...
    UnserializeData(reader) {
        ...
        switch (this.Type) {
            case VMType.Bool:
                this.Data = Serialization.Unserialize(reader, Boolean);
                break;
            case VMType.Bytes:
                this.Data = Serialization.Unserialize(reader, Uint8Array);
                break;
            case VMType.Number:
            ...
            case VMType.Object:
                ...
                if (bytes.length == 35) {
                    let addr = Serialization.Unserialize(bytes, Address);
                    this.Data = addr;
