...
import { VmDynamicStruct, VmNamedDynamicVariable, VmStructArray, VmType, } from "../../Vm/index.js";
...
export const seriesDefaultMetadataFields = [
    { name: StandardMeta.id.data, type: VmType.Int256 },
    { name: 'mode', type: VmType.Int8 },
    { name: 'rom', type: VmType.Bytes }
];
export const nftDefaultMetadataFields = [
    { name: StandardMeta.id.data, type: VmType.Int256 },
    { name: 'rom', type: VmType.Bytes }
];
...
export function findMetadataField(fields, name) {
    return fields.find(f => f.name.toLowerCase() === name.toLowerCase());
}
export function pushMetadataField(fieldSchema, metadata, metadataFields) {
