...
export class CreateTokenFeeOptions extends FeeOptions {
...
export class CreateSeriesFeeOptions extends FeeOptions {
...
export class MintNftFeeOptions extends FeeOptions {
    constructor(gasFeeBase = 10000n, feeMultiplier = 1000n) {
        super(gasFeeBase, feeMultiplier);
    }
    calculateMaxGas(..._args) {
