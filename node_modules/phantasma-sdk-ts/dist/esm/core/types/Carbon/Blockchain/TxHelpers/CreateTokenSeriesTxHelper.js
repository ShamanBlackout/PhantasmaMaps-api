...
import { TokenContract_Methods } from '../Modules/index.js';
...
export class CreateTokenSeriesTxHelper {
    ...
    static buildTx(tokenId, // ulong
    seriesInfo, creatorPublicKey, feeOptions, maxData, expiry) {
    ...
    static buildTxAndSign(tokenId, seriesInfo, signer, feeOptions, maxData, expiry) {
        const tx = this.buildTx(tokenId, seriesInfo, new Bytes32(signer.PublicKey), feeOptions, maxData, expiry);
        return TxMsgSigner.signAndSerialize(tx, signer);
    }
    /** Build, sign and return hex string. */
    static buildTxAndSignHex(tokenId, seriesInfo, signer, feeOptions, maxData, expiry) {
        return bytesToHex(this.buildTxAndSign(tokenId, seriesInfo, signer, feeOptions, maxData, expiry));
    }
