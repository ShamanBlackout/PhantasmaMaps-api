...
export function generateNewSeedWords() {
    let buffer = new Uint8Array(32);
    let privateKey = Buffer.alloc(32);
    crypto.getRandomValues(buffer);
    for (let i = 0; i < 32; ++i) {
...
export function generateNewWif() {
    let buffer = new Uint8Array(32);
    let privateKey = Buffer.alloc(32);
    crypto.getRandomValues(buffer);
    for (let i = 0; i < 32; ++i) {
...
export function signData(msgHex, privateKey) {
...
export function verifyData(msgHex, phaSig, address) {
