...
import { getLedgerBip32Factory, getLedgerBip39, getLedgerCurve, } from './interfaces/ledger-config.js';
// 60   | 0x80000273 | SOUL   | [Phantasma](https://phantasma.info/)
export const SOUL_COIN = 60;
/**
 ...
 */
export const getPrivateKeyFromMnemonic = (config, mnemonic, index) => {
 ...
 */
export const getPrivateKeyFromSeed = (config, seed, index) => {
 ...
 * @return returns the private key, hex encoded, upper case.
 */
export const getPoltergeistMnemonic = (config, mnemonic, index) => {
    const bip39 = getLedgerBip39(config);
 ...
 */
export const getBip44Path = (index) => {
