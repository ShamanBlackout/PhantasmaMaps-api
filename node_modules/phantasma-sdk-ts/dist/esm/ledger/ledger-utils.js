...
const Debug = true;
export const bip44Path = '8000002C' + // 44
    '8000003C' + // 60
    '80000000' + // 0
    '00000000' + // 0
    '00000000'; // 0
export const ledgerErrorDescriptions = {
...
const requireLedgerDevice = (device) => {
 ...
 * @returns
 */
export const getErrorMessage = (responseStr) => {
 ...
 * @returns
 */
export const getDevice = async (transport) => {
    /* istanbul ignore if */
    if (Debug) {
 ...
 * @returns
 */
export const getApplicationName = async (transport) => {
 ...
 * @returns
 */
export const getBip44PathMessage = (messagePrefix) => {
    /* istanbul ignore if */
    ...
    if (Debug) {
        logger.log('getBip44PathMessage', 'bip44PathBuffer', bip44PathBuffer.toString('hex').toUpperCase());
        logger.log('getBip44PathMessage', 'bip44PathBufferLen', bip44PathBufferLen);
        logger.log('getBip44PathMessage', 'bip44PathBufferLenBuffer', bip44PathBufferLenBuffer.toString('hex').toUpperCase());
 ...
 * @returns
 */
export const getPublicKey = async (transport, options) => {
    /* istanbul ignore if */
...
export const signLedger = async (transport, transactionHex) => {
    /* istanbul ignore if */
    if (Debug) {
    ...
    try {
        ...
        for (let ix = 0; ix < messages.length; ix++) {
            ...
            /* istanbul ignore if */
            if (Debug) {
                logger.log('exchange', ix, 'of', messages.length, 'message', message.toString('hex').toUpperCase());
            }
