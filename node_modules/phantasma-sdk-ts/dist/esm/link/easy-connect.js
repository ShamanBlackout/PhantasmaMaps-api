...
export class EasyConnect {
    ...
    deployContract(script, payload = null, proofOfWork = ProofOfWork.Minimal, onSuccess = () => { }, onFail = (data) => {
        logger.log('%cError: ' + data, 'color:red');
    }) {
