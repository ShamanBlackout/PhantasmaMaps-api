...
class MsgCallArgSections {
    ...
    write(w) {
        CarbonSerialization_js_1.Throw.Assert(this.argSections.length > 0, 'arg sections are empty');
    ...
    static readWithCount(r, countNegative) {
        CarbonSerialization_js_1.Throw.Assert(countNegative < 0, 'arg sections count must be negative');
