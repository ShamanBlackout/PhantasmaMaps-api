...
class Serialization {
    ...
    static SerializeEnum(obj) {
        ...
        let writer = new index_js_1.PBinaryWriter();
    ...
    static SerializeObject(writer, obj, type) {
        ...
        const structType = Object.getPrototypeOf(obj).constructor.name;
        ...
        if (obj instanceof Boolean || typeof obj == "boolean") {
            ...
            writer.writeByte((0, index_js_2.stringToUint8Array)(obj.toString()).length);
        ...
        else if (obj instanceof Timestamp_js_1.Timestamp) {
    ...
    static Unserialize(bytesOrBytes, type) {
        if (bytesOrBytes instanceof index_js_1.PBinaryReader) {
        ...
        let stream = new index_js_1.PBinaryReader(bytesOrBytes);
    ...
    static UnserializeObject(reader, type) {
        ...
        if (localType instanceof Boolean ||
        ...
        else if (localType instanceof Timestamp_js_1.Timestamp) {
            return new Timestamp_js_1.Timestamp(reader.readVarInt());
        }
            ...
            const fields = Object.keys(localType);
            /*console.log(fields);
            fields.forEach((field) => {
