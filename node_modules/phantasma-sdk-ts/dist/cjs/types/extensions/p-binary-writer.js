...
class PBinaryWriter {
    ...
    writeVarInt(value) {
        if (value < 0)
            throw new Error('negative value invalid');
        if (value < 0xfd) {
    ...
    appendHexEncoded(bytesHex) {
        const bytes = (0, index_js_1.hexToBytes)(bytesHex);
        this.writeVarInt(bytes.length);
        this.appendBytes(bytes);
        return this;
    }
