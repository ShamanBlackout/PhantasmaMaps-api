...
exports.TokenMetadataBuilder = void 0;
...
class TokenMetadataBuilder {
    static buildAndSerialize(fields) {
        ...
        for (const [key, value] of Object.entries(fields)) {
            metadataFields.push(index_js_1.VmNamedDynamicVariable.from(key, index_js_1.VmType.String, value));
        }
        const struct = new index_js_1.VmDynamicStruct();
        struct.fields = metadataFields;
        const wMetadata = new carbon_serialization_js_1.CarbonBinaryWriter();
...
TokenMetadataBuilder.iconDataUriPrefixPattern = /^data:image\/(png|jpeg|webp);base64,/i;
