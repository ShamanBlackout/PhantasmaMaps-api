...
class MsgCallArgSections {
    ...
    write(w) {
        carbon_serialization_js_1.Throw.Assert(this.argSections.length > 0, 'arg sections are empty');
    ...
    static readWithCount(r, countNegative) {
        carbon_serialization_js_1.Throw.Assert(countNegative < 0, 'arg sections count must be negative');
