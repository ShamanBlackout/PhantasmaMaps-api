...
class ContractMethod {
    ...
    constructor(name = '', returnType = vm_type_js_1.VMType.None, offset = 0, parameters = []) {
        this.name = name;
        this.offset = offset;
        this.returnType = returnType;
        this.parameters = parameters;
...
class ContractEvent {
    constructor(value = 0, name = '', returnType = vm_type_js_1.VMType.None, description = new Uint8Array()) {
        this.value = value;
        this.name = name;
        this.returnType = returnType;
